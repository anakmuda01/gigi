<template>
  <div class="pa-0">
    ...
    <v-toolbar card>
        ...
        ></v-text-field>
        <v-spacer></v-spacer>
        <v-btn @click="printRM" :small="$vuetify.breakpoint.xs" color="yellow" light>
          <v-icon small class="mr-2">print</v-icon>Cetak
        </v-btn>
    </v-toolbar>
    <v-data-table
      :headers="headers"
  ...
  export default {
    ...
    methods: {
      ...
      printRM(){
        ...
        //     tgl: '12 Juni 2019',
        //     ng: '41',
        //     diag: 'Diagnosa XXX, Diagnosa Tampan dan berani',
        //     terapi: [
        //       ['bakar'],['wow']
        //     ]
        //   },
        ...
        //     tgl: '12 Juni 2019',
        //     ng: '45',
        //     diag: 'Diagnosa TRALALALALALALALALAL',
        //     terapi: [
        //       ['bakar'], ['yeah']
        //     ]
        //   },
        ...
        //     tgl: '13 Juni 2019',
        //     ng: '75',
        //     diag: 'Diagnosa WEKEKE, Diagnosa TOTOTO',
        //     terapi: [
        //       ['bakar'], ['yeah']
        //     ]
        //   }
        ...
        for (var i = 0; i < body.length; i++) {
            var row = body[i];
            row['tgl'] = {rowSpan: row.jum, content: body[i].tgl, styles: {valign: 'middle', halign: 'center'}};
            row['ng'] = {content: row.ng, styles: {valign: 'middle', halign: 'center'}};
        }

        // let head = [{
        //   tgl:
        //   {
        //     content: 'Tgl Kunjungan', styles: {halign: 'center', fillColor: [22, 160, 133]}
        //   },
        //   ng:
        //   {
        //     content: 'N.G', styles: {halign: 'center', fillColor: [22, 160, 133]}
        //   },
        //   diag:{
        //     content: 'Diagnosa', styles: {halign: 'center', fillColor: [22, 160, 133]}
        //   },
        //   terapi:
        //   {
        //     content: 'Terapi/Tindakan', styles: {halign: 'center', fillColor: [22, 160, 133]},
        //   }
        // }]
        ...
        //     margin: 5,
        //     styles: {
        //       cellWidth: 'wrap', rowPageBreak: 'auto', halign: 'justify',
        //     },
