  ...
  export default {
    data: () => ({
      headers: [
        ...
        { text: 'Tgl Kunjungan', value: 'tgl_kunjungan', sortable: true },
    ...
    methods: {
      ...
      Print(){
        if(this.history.length > 0){
          ...
          doc.setFontSize(16);
          doc.setFontStyle('bold');
          doc.myText("RIWAYAT PEMBAYARAN",{align: "center"},0,34);
          doc.setFontSize(13);
          if(this.mode === "Detail"){
          ...
          doc.setFontSize(10);
          doc.setFontStyle('bold');
          doc.text(11, doc.autoTable.previous.finalY+5, 'Total Keseluruhan : '+this.formatDuit(tot))
