                        ...
                        <v-layout row>
                            <v-flex xs6>
                                <template v-for="i in $vuetify.breakpoint.xs || $vuetify.breakpoint.sm ? reg1 : reg1.slice().reverse()">
                                    ...
                                    :color="cekGigi('1'+i) ? 'red' : cekRahang('1'+i) ? 'orange' : 'secondary'" small icon :key="i">
                                        1{{i}}
                                    </v-btn>
                                    <v-tooltip v-else top :key="i">
                                        <template v-slot:activator="{ on }">
                                            <v-btn v-on="on"  @click.stop="!modeGigi ? chooseGigi('1'+i) : ''" icon small>
                                                <v-icon :color="cekGigi('1'+i) ? 'red': cekRahang('1'+i) ? 'orange' : ''" v-if="cekGigi('1'+i) || cekRahang('1'+i)">mdi-tooth</v-icon>
                            ...
                            <v-flex xs6>
                                <template v-for="i in reg1">
                                    ...
                                    :color="cekGigi('2'+i) ? 'red' : cekRahang('1'+i) ? 'orange' : 'secondary'" small icon :key="i">
                                        2{{i}}
                                    </v-btn>
                                    <v-tooltip v-else top :key="i">
                                        <template v-slot:activator="{ on }">
                                            <v-btn v-on="on"  @click="chooseGigi('2'+i)" icon small>
                                                <v-icon :color="cekGigi('2'+i) ? 'red': cekRahang('2'+i) ? 'orange' : ''" v-if="cekGigi('2'+i) || cekRahang('2'+i)">mdi-tooth</v-icon>
                                                <v-icon v-else>mdi-tooth-outline</v-icon>
                                            </v-btn>
                                        </template>
                                        <span>2{{i}}</span>
                        ...
                        <v-layout row>
                            <v-flex xs6>
                                <template v-for="i in $vuetify.breakpoint.xs || $vuetify.breakpoint.sm ? reg1 : reg1.slice().reverse()">
                                    ...
                                    :color="cekGigi('4'+i) ? 'red' : cekRahang('4'+i) ? 'orange' : 'secondary'" small icon :key="i">
                                        4{{i}}
                                    </v-btn>
                                    <v-tooltip v-else bottom :key="i">
                                        <template v-slot:activator="{ on }">
                                            <v-btn v-on="on"  @click="chooseGigi('4'+i)" icon small>
                                                <v-icon :color="cekGigi('4'+i) ? 'red': cekRahang('4'+i) ? 'orange' : ''" v-if="cekGigi('4'+i) || cekRahang('4'+i)">mdi-tooth</v-icon>
                                                <v-icon v-else>mdi-tooth-outline</v-icon>
                                            </v-btn>
                                        </template>
                                        <span>4{{i}}</span>
                            ...
                            <v-flex xs6>
                                <template v-for="i in reg1">
                                    ...
                                    :color="cekGigi('3'+i) ? 'red' : cekRahang('3'+i) ? 'orange' : 'secondary'" small icon :key="i">
                                        3{{i}}
                                    </v-btn>
                                    <v-tooltip v-else bottom :key="i">
                                        <template v-slot:activator="{ on }">
                                            <v-btn v-on="on"  @click="chooseGigi('3'+i)" icon small>
                                                <v-icon :color="cekGigi('3'+i) ? 'red': cekRahang('3'+i) ? 'orange' : ''" v-if="cekGigi('3'+i) || cekRahang('3'+i)">mdi-tooth</v-icon>
                                                <v-icon v-else>mdi-tooth-outline</v-icon>
                                            </v-btn>
                                        </template>
                                        <span>3{{i}}</span>
                        ...
                        <v-layout row>
                            <v-flex xs6>
                                <template v-for="i in $vuetify.breakpoint.xs || $vuetify.breakpoint.sm ? reg2 : reg2.slice().reverse()">
                                    ...
                                    :color="cekGigi('5'+i) ? 'red' : cekRahang('5'+i) ? 'lime lighten-2' : 'secondary'" small icon :key="i">
                                        5{{i}}
                                    </v-btn>
                                    <v-tooltip v-else top :key="i">
                                        <template v-slot:activator="{ on }">
                                            <v-btn v-on="on"  @click="chooseGigi('5'+i)" icon small>
                                                <v-icon :color="cekGigi('5'+i) ? 'pink': cekRahang('5'+i) ? 'lime lighten-2' : ''" v-if="cekGigi('5'+i) || cekRahang('5'+i)">mdi-tooth</v-icon>
                            ...
                            <v-flex xs6>
                                <template v-for="i in reg2">
                                    ...
                                    :color="cekGigi('6'+i) ? 'red' : cekRahang('6'+i) ? 'lime lighten-2' : 'secondary'" small icon :key="i">
                                        6{{i}}
                                    </v-btn>
                                    <v-tooltip v-else top :key="i">
                                        <template v-slot:activator="{ on }">
                                            <v-btn v-on="on"  @click="chooseGigi('6'+i)" icon small>
                                                <v-icon :color="cekGigi('6'+i) ? 'pink': cekRahang('6'+i) ? 'lime lighten-2' : ''" v-if="cekGigi('6'+i) || cekRahang('6'+i)">mdi-tooth</v-icon>
                                                <v-icon v-else color="green darken-4">mdi-tooth-outline</v-icon>
                                            </v-btn>
                                        </template>
                                        <span>6{{i}}</span>
                        ...
                        <v-layout row>
                            <v-flex xs6>
                                <template v-for="i in $vuetify.breakpoint.xs || $vuetify.breakpoint.sm ? reg2 : reg2.slice().reverse()">
                                    ...
                                    :color="cekGigi('8'+i) ? 'red' : cekRahang('8'+i) ? 'lime lighten-2' : 'secondary'" small icon :key="i">
                                        8{{i}}
                                    </v-btn>
                                    <v-tooltip v-else bottom :key="i">
                                        <template v-slot:activator="{ on }">
                                            <v-btn v-on="on"  @click="chooseGigi('8'+i)" icon small>
                                                <v-icon :color="cekGigi('8'+i) ? 'pink': cekRahang('8'+i) ? 'lime lighten-2' : ''" v-if="cekGigi('8'+i) || cekRahang('8'+i)">mdi-tooth</v-icon>
                                                <v-icon v-else color="green darken-4">mdi-tooth-outline</v-icon>
                                            </v-btn>
                                        </template>
                                        <span>8{{i}}</span>
                            ...
                            <v-flex xs6>
                                <template v-for="i in reg2">
                                    ...
                                    :color="cekGigi('7'+i) ? 'red' : cekRahang('7'+i) ? 'lime lighten-2' : 'secondary'" small icon :key="i">
                                        7{{i}}
                                    </v-btn>
                                    <v-tooltip v-else bottom :key="i">
                                        <template v-slot:activator="{ on }">
                                            <v-btn v-on="on"  @click="chooseGigi('7'+i)" icon small>
                                                <v-icon :color="cekGigi('7'+i) ? 'pink': cekRahang('7'+i) ? 'lime lighten-2' : ''" v-if="cekGigi('7'+i) || cekRahang('7'+i)">mdi-tooth</v-icon>
                                                <v-icon v-else color="green darken-4">mdi-tooth-outline</v-icon>
                                            </v-btn>
                                        </template>
                                        <span>7{{i}}</span>
                ...
                <v-card flat>
                    <v-toolbar flat color="white">              
                        <v-dialog scrollable fullscreen v-model="dialog" max-width="800px" persistent>
                                ...
                                <v-layout align-center justify-start>
                                    <div>
                                        ...
                                        <span class="headline white--text" v-else>
                                            ...
                                            <div>{{ editedItem.no_gigi !== null ? editedItem.no_gigi : gigiMulti.join(",") }}</div>
                                            </v-layout>
                                        </span>
                                    </div>
                                </v-layout>
                            ...
                            <v-card-text class="px-1 pt-0">
                                <v-stepper v-model="e1">
                                    ...
                                    <v-stepper-step :complete="e1 > 4" step="4" :editable="editedIndex > -1">Tindakan</v-stepper-step>

                                    <v-divider></v-divider>

                                    <v-stepper-step step="5" :editable="editedIndex > -1">Keterangan</v-stepper-step>
                                            ...
                                            <v-card-text v-if="modeBanyak">
                                                    ...
                                                    <v-flex xs12 class="text-xs-center">
                                                        ...
                                                        <v-layout row align-center>
                                                            <v-flex xs1 class="toggleIcon" @click="toggleOne()">
                                                                <v-layout row wrap justify-center align-center>
                                                                    <v-icon :color="toggleOneIcon ? 'primary' : 'secondary'" class="my-2" :class="{'mr-2': !$vuetify.breakpoint.xs}">{{toggleOneIcon ? 'mdi-checkbox-marked' : 'mdi-minus-box'}}</v-icon>
                                                                    <span>Rahang 1</span>
                                                                </v-layout>
                                                            </v-flex>
                                                            <v-flex xs5>
                                                            ...
                                                            <v-flex xs1 class="toggleIcon" @click="toggleTwo()">
                                                                <v-layout row wrap justify-center align-center>
                                                                    <span>Rahang 2</span>
                                                                    <v-icon :color="toggleTwoIcon ? 'primary' : 'secondary'" class="my-2" :class="{'ml-2': !$vuetify.breakpoint.xs}">{{toggleTwoIcon ? 'mdi-checkbox-marked' : 'mdi-minus-box'}}</v-icon>
                                                                </v-layout>
                                                            </v-flex>
                                                        </v-layout>
                                                        <v-divider></v-divider>
                                                        <v-layout row align-center>
                                                            <v-flex xs1 class="toggleIcon" @click="toggleFour()">
                                                                <v-layout row wrap justify-center align-center>
                                                                    <v-icon :color="toggleFourIcon ? 'primary' : 'secondary'" class="my-2" :class="{'mr-2': !$vuetify.breakpoint.xs}">{{toggleFourIcon ? 'mdi-checkbox-marked' : 'mdi-minus-box'}}</v-icon>
                                                                    <span>Rahang 4</span>
                                                                </v-layout>
                                                            </v-flex>
                                                            <v-flex xs5>
                                                            ...
                                                            <v-flex xs1 class="toggleIcon" @click="toggleThree()">
                                                                <v-layout row wrap justify-center align-center>
                                                                    <span>Rahang 3</span>
                                                                    <v-icon :color="toggleThreeIcon ? 'primary' : 'secondary'" class="my-2" :class="{'ml-2': !$vuetify.breakpoint.xs}">{{toggleThreeIcon ? 'mdi-checkbox-marked' : 'mdi-minus-box'}}</v-icon>
                                                                </v-layout>
                                                            </v-flex>
                                                        </v-layout>
                                                        <v-divider></v-divider>
                                                ...
                                                <v-layout justify-center align-center>
                                                    <v-flex xs12 class="text-xs-center">
                                                        <v-divider></v-divider>
                                                        <v-layout row>
                                                            <v-flex xs1 class="toggleIcon" @click="toggleFive()">
                                                                <v-layout row wrap justify-center align-center>
                                                                    <v-icon :color="toggleFiveIcon ? 'primary' : 'secondary'" class="my-2" :class="{'mr-2': !$vuetify.breakpoint.xs}">{{toggleFiveIcon ? 'mdi-checkbox-marked' : 'mdi-minus-box'}}</v-icon>
                                                                    <span>Rahang 5</span>
                                                                </v-layout>
                                                            </v-flex>
                                                            <v-flex xs5>
                                                                <template v-for="i in $vuetify.breakpoint.xs || $vuetify.breakpoint.sm ? reg2 : reg2.slice().reverse()">
                                                                    <v-btn v-if="$vuetify.breakpoint.xs || $vuetify.breakpoint.sm" class="white--text" @click="pushGigi('5'+i)" 
                                                                    :color="cekGM('5'+i) ? 'red' : 'secondary'" small icon :key="i">
                                                                        5{{i}}
                                                                    </v-btn>
                                                                    <v-tooltip v-else top :key="i">
                                                                        <template v-slot:activator="{ on }">
                                                                            <v-btn v-on="on"  @click.stop="!modeGigi ? pushGigi('5'+i) : ''" icon small>
                                                                                <v-icon color="brown" v-if="cekGM('5'+i)">mdi-tooth</v-icon>
                                                                                <v-icon v-else color="green darken-4" >mdi-tooth-outline</v-icon>
                                                                            </v-btn>
                                                                        </template>
                                                                        <span>5{{i}}</span>
                                                            ...
                                                            <v-flex xs5>
                                                                <template v-for="i in reg2">
                                                                    <v-btn v-if="$vuetify.breakpoint.xs || $vuetify.breakpoint.sm" class="white--text" @click="pushGigi('6'+i)" 
                                                                    :color="cekGM('6'+i) ? 'red' : 'secondary'" small icon :key="i">
                                                                        6{{i}}
                                                                    </v-btn>
                                                                    <v-tooltip v-else top :key="i">
                                                                        <template v-slot:activator="{ on }">
                                                                            <v-btn v-on="on"  @click="pushGigi('6'+i)" icon small>
                                                                                <v-icon color="brown" v-if="cekGM('6'+i)">mdi-tooth</v-icon>
                                                                                <v-icon v-else color="green darken-4" >mdi-tooth-outline</v-icon>
                                                                            </v-btn>
                                                                        </template>
                                                                        <span>6{{i}}</span>
                                                            ...
                                                            <v-flex xs1 class="toggleIcon" @click="toggleSix()">
                                                                <v-layout row wrap justify-center align-center>
                                                                    <span>Rahang 6</span>
                                                                    <v-icon :color="toggleSixIcon ? 'primary' : 'secondary'" class="my-2" :class="{'ml-2': !$vuetify.breakpoint.xs}">{{toggleSixIcon ? 'mdi-checkbox-marked' : 'mdi-minus-box'}}</v-icon>
                                                                </v-layout>
                                                            </v-flex>
                                                        </v-layout>
                                                        <v-divider></v-divider>
                                                        <v-layout row>
                                                            <v-flex xs1 class="toggleIcon" @click="toggleEight()">
                                                                <v-layout row wrap justify-center align-center>
                                                                    <v-icon :color="toggleEightIcon ? 'primary' : 'secondary'" class="my-2" :class="{'mr-2': !$vuetify.breakpoint.xs}">{{toggleEightIcon ? 'mdi-checkbox-marked' : 'mdi-minus-box'}}</v-icon>
                                                                    <span>Rahang 8</span>
                                                                </v-layout>
                                                            </v-flex>
                                                            <v-flex xs5>
                                                                <template v-for="i in $vuetify.breakpoint.xs || $vuetify.breakpoint.sm ? reg2 : reg2.slice().reverse()">
                                                                    <v-btn v-if="$vuetify.breakpoint.xs || $vuetify.breakpoint.sm" class="white--text" @click="pushGigi('8'+i)" 
                                                                    :color="cekGM('8'+i) ? 'red' : 'secondary'" small icon :key="i">
                                                                        8{{i}}
                                                                    </v-btn>
                                                                    <v-tooltip v-else bottom :key="i">
                                                                        <template v-slot:activator="{ on }">
                                                                            <v-btn v-on="on" @click="pushGigi('8'+i)" icon small>
                                                                                <v-icon color="brown" v-if="cekGM('8'+i)">mdi-tooth</v-icon>
                                                                                <v-icon v-else color="green darken-4" >mdi-tooth-outline</v-icon>
                                                                            </v-btn>
                                                                        </template>
                                                                        <span>8{{i}}</span>
                                                            ...
                                                            <v-flex xs5>
                                                                <template v-for="i in reg2">
                                                                    <v-btn v-if="$vuetify.breakpoint.xs || $vuetify.breakpoint.sm" class="white--text" @click="pushGigi('7'+i)"  
                                                                    :color="cekGM('7'+i) ? 'red' : 'secondary'" small icon :key="i">
                                                                        7{{i}}
                                                                    </v-btn>
                                                                    <v-tooltip v-else bottom :key="i">
                                                                        <template v-slot:activator="{ on }">
                                                                            <v-btn v-on="on" @click="pushGigi('7'+i)"  icon small>
                                                                                <v-icon color="brown" v-if="cekGM('7'+i)">mdi-tooth</v-icon>
                                                                                <v-icon v-else color="green darken-4" >mdi-tooth-outline</v-icon>
                                                                            </v-btn>
                                                                        </template>
                                                                        <span>7{{i}}</span>
                                                            ...
                                                            <v-flex xs1 class="toggleIcon" @click="toggleSeven()">
                                                                <v-layout row wrap justify-center align-center>
                                                                    <span>Rahang 7</span>
                                                                    <v-icon :color="toggleSevenIcon ? 'primary' : 'secondary'" class="my-2" :class="{'ml-2': !$vuetify.breakpoint.xs}">{{toggleSevenIcon ? 'mdi-checkbox-marked' : 'mdi-minus-box'}}</v-icon>
                                                                </v-layout>
                                                            </v-flex>
                                                        </v-layout>
                                                        <v-divider></v-divider>
                        ...
                        <v-btn color="secondary" @click="chooseBanyak">
                            <v-icon small class="mr-1">mdi-tooth</v-icon>
                            Pilih Gigi Banyak
                        </v-btn>
                        <v-spacer></v-spacer>
                        <!-- tombol show-sujuk -->
                    ...
                    <template v-slot:items="props">
                        ...
                        <template v-if="props.item.no_gigi.length > 2">
                            <td :class="{'caption': $vuetify.breakpoint.xs}" class="text-xs-left">
                                <div v-for="num_gi in rangeNOGI(hancurKan(props.item.no_gigi).length)" :key="num_gi">
                                    <span v-for="val_gi in hancurKan(props.item.no_gigi).slice((num_gi-1)*4, (num_gi-1)*4+4)" :key="val_gi">
                                        {{val_gi}}
                                    </span>
                                </div>
                            </td>
                        </template>
                        <td v-else :class="{'caption': $vuetify.breakpoint.xs}" class="text-xs-left">
                            {{ props.item.no_gigi }} 
                        </td>
                        <td :class="{'caption': $vuetify.breakpoint.xs}" class="text-xs-left">
                        ...
                        <td @click.stop="" class="text-xs-center">
                            ...
                            <v-layout wrap column class="pa-0">
                                <v-flex xs12 sm12 md12 lg12>
                                    <v-layout wrap column>
                                        <v-card-title class="py-1"><h4><v-icon small>mdi-information</v-icon> Keterangan Pemeriksaan :</h4>
                                        </v-card-title>
                                        <v-divider></v-divider>
                                        <v-card-text>
                                            {{ props.item.ket ? (props.item.ket.isi_ket !== null ? props.item.ket.isi_ket : 'Tidak ada keterangan') : 'Tidak ada keterangan' }}
                                        </v-card-text>
                                    </v-layout>
                                </v-flex>
                                <v-divider></v-divider>
                                <v-flex xs12 sm12 md12 lg12>
                                    <v-layout wrap row>
                                        <v-card-title class="py-1 px-3"><h4><v-icon small>layers</v-icon> Kondisi N.G: <span class="green--text text--darken-3">[ {{props.item.no_gigi}} ]</span></h4>
                                        </v-card-title>
                                    </v-layout>
                                </v-flex>
                                <v-divider></v-divider>
          ...
          <v-card height="100%">
            <v-layout column fill-height>
                <v-toolbar dark color="indigo darken-2">
                    <v-icon dark medium>mdi-tooth</v-icon>
                    <v-toolbar-title class="white--text">
                        {{ rujukItem.ng }} Rujukan
                    </v-toolbar-title>
                    <v-spacer></v-spacer>
              ...
              <!-- <v-card-actions class="indigo darken-2">
                  <v-layout wrap row class="white--text ml-2 caption">
                    <v-icon dark medium class="mr-2">mdi-tooth</v-icon>
...
const aral = ['51','52','53','54','55'];
const arar = ['61','62','63','64','65'];
const arbr = ['71','72','73','74','75'];
const arbl = ['81','82','83','84','85'];
  ...
  export default {
    ...
    data () {
      return {
        ...
        arrProtesa: ['Denture Acrylic', 'Denture Valplast','Porcelain/Crown/Bridge','Denture Polycarbonate', 'Metal Frame', 'Flexy', 'Luciton'],
        headers: [
          {
            text: '#',
            align: 'center',
        ...
        toggleFiveIcon: false,
        toggleSixIcon: false,
        toggleSevenIcon: false,
        toggleEightIcon: false,
      }
    },
    computed: {
        ...mapState([
    ...
    methods: {
        ...
        editItem (item) {
            ...
            this.keterangan = item.ket ? item.ket.isi_ket : ''
        ...
        chooseGigi(nomor) {     
            ...
            if(cek){
                ...
                this.keterangan = gis.ket ? gis.ket.isi_ket : ''
        ...
        pilihKondisi(){
            ...
            axios.post('/api/tambah-kondisi/'+this.editedItem.id_gigi, {kons: this.checked}).then((response) => {
                setTimeout(()=>{
                    toast.fire({
                    type: 'success',
                    title: 'Kondisi berhasil disimpan~'
                    })
                    this.initialize()
                    this.loadingBtn = false
                    this.loadingTB = false
        ...
        addKet(){
            ...
            //     axios.post('/api/tambah-ket/'+this.editedItem.id_gigi, {isi_ket: this.keterangan}).then((response) => {
            //         setTimeout(()=>{
            //             toast.fire({
            //             type: 'success',
            //             title: 'Keterangan berhasil ditambahkan~'
            //             })
            //             this.initialize()
            //             this.loadingBtn = false
            //             this.loadingTB = false
            ...
            //         toast.fire({
            //         type: 'info',
            //         title: 'Tidak ada keterangan yang ditambahkan~'
            //         })
            //         this.loadingBtn = false
            //         this.loadingTB = false
            //         this.$Progress.finish()
            ...
            axios.post('/api/tambah-ket/'+this.editedItem.id_gigi, {isi_ket: this.keterangan}).then((response) => {
                setTimeout(()=>{
                    ...
                    setTimeout(()=>{
                        toast.fire({
                            type: 'success',
                            title: 'Pemeriksaan gigi telah diselesaikan~'
                        })
                        this.close()
                    },500)
                }, 1000)
            ...
            if(this.$refs.formRujukan.validate()){
                ...
                axios.post('/api/make-rujukan', this.rujukItem).then((response)=>{
                    if(response.data.msg === 'save'){
                        ...
                        toast.fire({
                            type: 'success',
                            title: 'Data rujukan gigi berhasil disimpan~'
                        })
                    }
                    this.initialize()
                    this.loadingBtn = false
                ...
                if(response.data.jum > 0){
                    ...
                    for(let i=0;i<this.gigis.length; i++){
                        if(this.gigis[i].rujuk){
                            set.push(this.gigis[i].no_gigi.split(','))
                        }
                    }
                    ...
                    doc.autoTable({
                        ...
                        theme: 'grid',
                        styles: {
                            rowPageBreak: 'auto', halign: 'left', valign: 'top'
                        },
                        headStyles: {halign: 'center', fillColor: [48,63,159]},
                        columnStyles: {
                            index: {halign: 'center'},
                            ng: {cellWidth: 15, halign: 'center'},
                            klinis: {CellWidth: 20}
                        },
                    ...
                    if(doc.autoTable.previous.finalY+90 > doc.internal.pageSize.height-10){
                        ...
                        doc.setFontStyle('normal');
                        doc.text(120,30, this.setItem.kota+', '+format(now, 'DD MMMM YYYY', {locale: id}))
                        doc.text(120,35, 'Hormat Kami,')
                        doc.text(120,50, this.setItem.atas_nama)
                        doc.text(120,55, 'SIP. NO. '+this.setItem.no_sip)
                    }else{
                        doc.setFontSize(13);
                        doc.setFontStyle('normal');
                        ...
                        doc.setFontStyle('normal');
                        doc.text(120,doc.autoTable.previous.finalY+60, this.setItem.kota+', '+format(sur.tgl_rujukan, 'DD MMMM YYYY', {locale: id}))
                        doc.text(120,doc.autoTable.previous.finalY+65, 'Hormat Kami,')
                        doc.text(120,doc.autoTable.previous.finalY+85, this.setItem.atas_nama)
                        doc.text(120,doc.autoTable.previous.finalY+90, 'SIP. NO. '+this.setItem.no_sip)
                    }
        ...
        pushGigi(g){
            ...
            if (index > -1) {
                ...
                let five = _.difference(aral, this.gigiMulti).length !== 0;
                let six = _.difference(arar, this.gigiMulti).length !== 0;
                let seven = _.difference(arbr, this.gigiMulti).length !== 0;
                let eight = _.difference(arbl, this.gigiMulti).length !== 0;
                if(one){
                    this.toggleOneIcon = false
                }
                if(two){
                ...
                if(five){
                    this.toggleFiveIcon = false
                }
                if(six){
                    this.toggleSixIcon = false
                }
                if(seven){
                    this.toggleSevenIcon = false
                }
                if(eight){
                    this.toggleEightIcon = false
                }
            }else{
                ...
                if(five){
                    this.toggleFiveIcon = true
                }
                if(six){
                    this.toggleSixIcon = true
                }
                if(seven){
                    this.toggleSevenIcon = true
                }
                if(eight){
                    this.toggleEightIcon = true
                }
            }
        ...
        toggleFive(){
            if(!this.toggleFiveIcon){
                this.gigiMulti = _.union(this.gigiMulti, aral)
                this.toggleFiveIcon = true
            }else{
                var arr = this.gigiMulti
                for(let i=0;i<aral.length;i++){
                    var index = arr.indexOf(aral[i]);
        ...
        toggleSix(){
            if(!this.toggleSixIcon){
                this.gigiMulti = _.union(this.gigiMulti, arar)
                this.toggleSixIcon = true
            }else{
                var arr = this.gigiMulti
                for(let i=0;i<arbl.length;i++){
                    var index = arr.indexOf(arbl[i]);
        ...
        toggleSeven(){
            if(!this.toggleSevenIcon){
                this.gigiMulti = _.union(this.gigiMulti, arbr)
                this.toggleSevenIcon = true
            }else{
                var arr = this.gigiMulti
                for(let i=0;i<arbl.length;i++){
        ...
        toggleEight(){
            if(!this.toggleEightIcon){
                this.gigiMulti = _.union(this.gigiMulti, arbl)
                this.toggleEightIcon = true
            }else{
                var arr = this.gigiMulti
                for(let i=0;i<arbl.length;i++){
