                ...
                <v-layout column>
                        ...
                        <v-layout column justify-center align-center>
                            <v-flex mb-2>
                                <v-switch
                                    ...
                                    color="primary"
                                    class="black--text"
                                    :label="`Multiple : ${modeGigi ? 'On' : 'Off'}`"
                                    hide-details
                                    :disabled="disMode"
                                ></v-switch>
                            </v-flex>
                    ...
                    <v-flex xs12 class="text-xs-center">
                        ...
                        <v-layout row align-center>
                            <v-flex xs1 v-if="modeGigi">
                                <v-layout column justify-center align-center>
                                    <v-checkbox color="primary" v-model="rahangOne" :disabled="disOne" hide-details></v-checkbox>
                                    <span>Rahang 1</span>
                                </v-layout>
                            </v-flex>
                            <v-flex :class="{'xs5' : modeGigi, 'xs6': !modeGigi}">
                                <template v-for="i in $vuetify.breakpoint.xs || $vuetify.breakpoint.sm ? reg1 : reg1.slice().reverse()">
                                    <v-btn v-if="$vuetify.breakpoint.xs || $vuetify.breakpoint.sm" class="white--text" @click="!modeGigi ? chooseGigi('1'+i) : pushGigi('1'+i)" 
                                    :color="cekGigi('1'+i) ? 'red' : 'secondary'" small icon :key="i">
                                        1{{i}}
                                    </v-btn>
                                    <v-tooltip v-else top :key="i">
                                        <template v-slot:activator="{ on }">
                                            <v-btn v-on="on"  @click="!modeGigi ? chooseGigi('1'+i) : pushGigi('1'+i)" icon small>
                                                <v-icon color="red" v-if="cekGigi('1'+i) || cekGM('1'+i) || cekRahang('1'+i)">mdi-tooth</v-icon>
                                                <v-icon v-else :color="modeGigi ? 'grey' : 'black'">{{!modeGigi ? 'mdi-tooth-outline' : 'mdi-tooth'}}</v-icon>
                                            </v-btn>
                                        </template>
                                        <span>1{{i}}</span>
                                    </v-tooltip>
                            ...
                            <v-flex :class="{'xs5' : modeGigi, 'xs6': !modeGigi}">
                                <template v-for="i in reg1">
                                    <v-btn v-if="$vuetify.breakpoint.xs || $vuetify.breakpoint.sm" class="white--text" @click="!modeGigi ? chooseGigi('2'+i) : pushGigi('2'+i)"
                                    :color="cekGigi('2'+i) ? 'red' : 'secondary'" small icon :key="i">
                                        2{{i}}
                                    </v-btn>
                                    <v-tooltip v-else top :key="i">
                                        <template v-slot:activator="{ on }">
                                            <v-btn v-on="on"  @click="!modeGigi ? chooseGigi('2'+i) : pushGigi('2'+i)" icon small>
                                                <v-icon color="red" v-if="cekGigi('2'+i) || cekGM('2'+i) || cekRahang('2'+i)">mdi-tooth</v-icon>
                            ...
                            <v-flex xs1 v-if="modeGigi">
                                <v-layout column justify-center align-center>
                                    <v-checkbox color="primary" v-model="rahangTwo" :disabled="disTwo" hide-details></v-checkbox>
                                    <span>Rahang 2</span>
                                </v-layout>
                            </v-flex>
                        </v-layout>
  ...
  export default {
    ...
    watch: {
        modeGigi(val){
            if(val == false){
                this.gigiMulti = []
                this.rahangOne = false
                this.rahangTwo = false
            }
        },
        rahangOne(val){
            if(val == true){
                if(this.gigiMulti.length > 0){
                    var ral = ['11','12','13','14','15','16','17','18']
                    this.gigiMulti = _.union(this.gigiMulti,ral)
                }else{
                    this.gigiMulti.push('11','12','13','14','15','16','17','18')
                }
            }else{
        ...
        rahangTwo(val){
            if(val == true){
                if(this.gigiMulti.length > 0){
                    var rar = ['21','22','23','24','25','26','27','28']
                    this.gigiMulti = _.union(this.gigiMulti,rar)
                }else{
                    this.gigiMulti.push('21','22','23','24','25','26','27','28')
                }
            }else{
                var arr = this.gigiMulti
                var rar = ['21','22','23','24','25','26','27','28']
    ...
    methods: {
        ...
        pilihGigi(){
            ...
            this.loadingBtn = true
            this.loadingTB = true
            let numGigi = !this.modeGigi ? this.editedItem.no_gigi : this.gigiMulti.join(',')
        ...
        cekRahang(gigi){
            ...
            var ral = ['11','12','13','14','15','16','17','18']
            let tesRAL = this.setRahang.includes(ral)
            if(tesRAL){
                this.rahangOne = true
                this.disOne = true
                this.modeGigi = true
            ...
            var rar = ['21','22','23','24','25','26','27','28']
            let tesRAR = this.setRahang.includes(rar)
            if(tesRAR){
                this.rahangTwo = true
                this.disTwo = true
                this.modeGigi = true
